...
public class AddTeacher extends JFrame {
	...
	public AddTeacher() {
		...
		setIconImage(Toolkit.getDefaultToolkit().getImage("C:\\Users\\toshiba\\Desktop\\Courses\\OOP2\\University Management System\\src\\icons\\icon2.png"));
		setResizable(false);
					...
					try {
						...
						Class.forName("oracle.jdbc.driver.OracleDriver");
							connection =  DriverManager.getConnection("jdbc:oracle:thin:@localhost:1521:ORCL","SYSTEM","SYSTEM");
							 PreparedStatement psInsertStudent = connection.prepareStatement("insert into teacher (FIRST_NAME,LAST_NAME,AGE,PHONE_NUMBER,DOB,ADDRESS,DEPARTMENT) values(?,?,?,?,?,?,?)");
